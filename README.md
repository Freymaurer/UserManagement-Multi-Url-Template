...
In the Server.fs file (line 128 following) are Client Secrets and IDs for OAuth support, and in line ~150 should be the connection string to the usermanagement database (the one created by the c# dummy project).
